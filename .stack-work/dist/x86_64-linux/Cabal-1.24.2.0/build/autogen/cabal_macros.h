...
/* package hs-practice-0.1.0.0 */
#define VERSION_hs_practice "0.1.0.0"
#define MIN_VERSION_hs_practice(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "hs-practice-0.1.0.0"

#define CURRENT_PACKAGE_KEY "hs-practice-0.1.0.0"
